...
Customizable, composable and testable CSS utilities for mobile browsers.

Stencil Utilities provides basic CSS patterns or frequently used properties that can be used in various one-off situations to apply simple, straight-forward changes in appearance or spacing.
...
* [Dimension](https://github.com/mobify/stencil/tree/master/dist/dimension)
* [Layout](https://github.com/mobify/stencil/tree/master/dist/layout)
* [Spacing](https://github.com/mobify/stencil/tree/master/dist/spacing)
* [Text](https://github.com/mobify/stencil/tree/master/dist/text)
* [Visibility](https://github.com/mobify/stencil/tree/master/dist/visibility)
...
The process below describes how to create a new component. The steps are described using `components` but the process is identical for `utils`. When building a new utility, simply replace all references to `components` with `utils`. For example: instead of `/dist/components/component-name/component-name.scss`, it's `/dist/utils-name/utils-name.scss`.
